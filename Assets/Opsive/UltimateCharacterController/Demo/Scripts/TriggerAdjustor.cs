...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    public class TriggerAdjustor : MonoBehaviour
    {
        ...
        [SerializeField] protected float m_MeshColliderInflate;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (m_Collider is BoxCollider) {
                ...
                InflateMeshCollider(m_Collider as MeshCollider, m_MeshColliderInflate);
            }
        ...
        /// <summary>
        /// Inflates the MeshCollider by the specified amount.
        /// </summary>
        /// <param name="meshCollider">The MeshCollider that should be inflated.</param>
        /// <param name="amount">The amount to inflate the MeshCollider by.</param>
        private void InflateMeshCollider(MeshCollider meshCollider, float amount)
        {
            // Only convex meshes can inflate.
            if (!meshCollider.convex) {
                return;
            }

            meshCollider.inflateMesh = true;
            meshCollider.skinWidth += amount;
        }
