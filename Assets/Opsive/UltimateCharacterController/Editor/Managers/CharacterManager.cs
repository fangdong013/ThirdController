...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class CharacterManager : Manager
    {
        ...
        private void DrawNewCharacter()
        {
            ...
            if (character != m_AddCharacter) {
                ...
                if (m_AddModelType == ModelType.Humanoid) {
                    ...
                    m_AddAnimatorController = AssetDatabase.LoadAssetAtPath(baseDirectory + "Demo/Animator/Characters/Demo.controller", typeof(RuntimeAnimatorController)) as RuntimeAnimatorController;
                }
            }
        ...
        private bool CheckValidCharacter(GameObject character, bool buildCharacter)
        {
            ...
            if (PrefabUtility.GetPrefabType(character) == PrefabType.Prefab) {
            ...
            if (animator) {
                ...
                if (selectedModelType != modelType) {
                    ...
                    if (modelType == ModelType.Humanoid) {
                        ...
                        var baseDirectory = System.IO.Path.GetDirectoryName(AssetDatabase.GetAssetPath(MonoScript.FromScriptableObject(m_MainManagerWindow))).Replace("Editor/Managers", "");
                        animatorController = AssetDatabase.LoadAssetAtPath(baseDirectory + "Demo/Animator/Characters/Demo.controller", typeof(RuntimeAnimatorController)) as RuntimeAnimatorController;
                    } else {
