...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class ItemManager : Manager
    {
        ...
        private void DrawNewItem()
        {
            ...
            if (m_FirstPersonObject == null && m_FirstPersonVisibleItem == null && m_ThirdPersonObject == null) {
                if (canBuild) {
                    EditorGUILayout.HelpBox("An object must be specified.", MessageType.Error);
                    canBuild = false;
                }
            }
            ...
            if (GUILayout.Button("Build Item")) {
                var item = ItemBuilder.BuildItem(m_Name, m_ItemType, m_AnimatorItemID, m_Character, m_SlotID, m_AddToDefaultLoadout, m_FirstPersonObject, m_FirstPersonObjectAnimatorController,
                    m_FirstPersonVisibleItem, m_FirstPersonItemSlot, m_FirstPersonVisibleItemAnimatorController, m_ThirdPersonObject, m_ThirdPersonItemSlot, m_ThirdPersonObjectAnimatorController,
