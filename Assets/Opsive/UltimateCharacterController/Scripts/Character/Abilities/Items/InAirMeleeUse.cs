...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class InAirMeleeUse : Use
    {
        ...
        [SerializeField] protected Vector3 m_UpwardForce = new Vector3(0, 0.1f, 0);
        ...
        [SerializeField] protected Vector3 m_DownwardForce = new Vector3(0, -0.2f, 0);
        ...
        {
            // The character needs to be in the air or have an active jump for the ability to start.
