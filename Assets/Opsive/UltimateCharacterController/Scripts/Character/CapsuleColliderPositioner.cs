...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class CapsuleColliderPositioner : StateBehavior
    {
        ...
        [NonSerialized] public Transform SecondEndCapTarget { get { return m_SecondEndCapTarget; } set { m_SecondEndCapTarget = value; } }
        ...
        protected override void Awake()
        {
            ...
            EventHandler.RegisterEvent(m_CharacterGameObject, "OnAnimatorSnapped", Initialize);
        ...
        public void UpdateRotationHeight()
        {
            ...
            if (m_RotateCollider) {
                ...
                Debug.DrawLine(firstEndCap, secondEndCap, Color.blue);
