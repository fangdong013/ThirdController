...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class CharacterFootEffects : StateBehavior
    {
        ...
        [SerializeField] protected float m_FootOffset = 0.01f;
        ...
        private void DetectBodyStep()
        {
            for (int i = 0; i < m_Feet.Length; ++i) {
                ...
                if (verticalOffset < m_LastVerticalOffset[i]) {
                    ...
                    if ((m_UpCount[i] > m_MoveDirectionFrameCount || m_DownCount[i] > m_MoveDirectionFrameCount) && 
        ...
        private void UpdateFixedInterval()
        {
            ...
            if (m_LastFootstepTime + m_Interval > Time.time) {
                return;
            }
        ...
        private void DetectCameraBob()
        {
            ...
            if (m_LastVerticalOffset[0] > m_VerticalOffset[0] && verticalOffset > m_VerticalOffset[0] && m_LastFootstepTime + m_MinBobInterval < Time.time) {
                GroupFootStep();
                m_LastFootstepTime = Time.time;
            }
