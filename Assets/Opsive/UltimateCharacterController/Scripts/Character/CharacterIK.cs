...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class CharacterIK : CharacterIKBase
    {
        ...
        public override void SetItemIKTargets(Transform itemHand, Transform nonDominantHandTarget, Transform nonDominantHandElbowTarget)
        {
        ...
        private void RotateHands()
        {
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                if (m_HandRotationIKWeight[i] > 0) {
                    if (ikTarget != null) {
                        m_Animator.SetIKRotation(ikGoal, m_Transform.rotation * ikTarget.localRotation);
                    } else {
        ...
        private void PositionHands()
        {
            for (int i = 0; i < 2; ++i) {
                ...
                if (m_HandPositionIKWeight[i] > 0) {
                    if (ikTarget != null) {
                        m_Animator.SetIKPosition(ikGoal, ikTarget.position);
                        if (hintTarget != null) {
