...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class ShootableWeapon : UsableItem, IReloadableItem
    {
        ...
        public override bool CanUseItem(ItemAbility itemAbility, bool startAbility)
        {
            ...
            if (!m_ShootableWeaponPerspectiveProperties.CanFire(!startAbility, m_FireInLookSourceDirection && !m_CharacterLocomotion.ActiveMovementType.UseIndependentLook(true))) {
                return false;
            }
