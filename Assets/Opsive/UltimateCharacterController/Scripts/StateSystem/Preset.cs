...
namespace Opsive.UltimateCharacterController.StateSystem
{
    ...
    public class Preset : ScriptableObject
    {
        ...
        /// </summary>
#if NET_4_6 || UNITY_WEBGL || UNITY_IOS || UNITY_ANDROID || UNITY_WII || UNITY_PS3 || UNITY_PS4 || UNITY_XBOXONE || UNITY_WSA
...
#if NET_4_6 || UNITY_WEBGL || UNITY_IOS || UNITY_ANDROID || UNITY_WII || UNITY_PS3 || UNITY_PS4 || UNITY_XBOXONE || UNITY_WSA
                    m_Value = (T)Serializer.BytesToValue(typeof(T), property.Name, valuePositionMap, 0, data.Values, data.ValuePositions, data.UnityObjects, false, visibility);
#else
