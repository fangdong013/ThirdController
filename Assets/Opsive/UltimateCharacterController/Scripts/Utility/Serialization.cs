...
#if (UNITY_WINRT || UNITY_WSA) && !UNITY_EDITOR
using BindingFlags = System.BindingFlags;
#endif
...
namespace Opsive.UltimateCharacterController.Utility
{
    ...
    public static class Serializer
    {
        ...
        public static Vector2 BytesToVector2(byte[] values, int valuePosition)
        {
            ...
            value.x = BitConverter.ToSingle(values, valuePosition);
            value.y = BitConverter.ToSingle(values, valuePosition + 4);
            return value;
        }
        ...
        public static Vector3 BytesToVector3(byte[] values, int valuePosition)
        {
            ...
            value.x = BitConverter.ToSingle(values, valuePosition);
            value.y = BitConverter.ToSingle(values, valuePosition + 4);
            value.z = BitConverter.ToSingle(values, valuePosition + 8);
            return value;
        }
        ...
        public static Vector4 BytesToVector4(byte[] values, int valuePosition)
        {
            ...
            value.y = BitConverter.ToSingle(values, valuePosition + 4);
            value.z = BitConverter.ToSingle(values, valuePosition + 8);
            value.w = BitConverter.ToSingle(values, valuePosition + 12);
            return value;
        }
        ...
        public static Color BytesToColor(byte[] values, int valuePosition)
        {
            ...
            color.r = BitConverter.ToSingle(values, valuePosition);
            color.g = BitConverter.ToSingle(values, valuePosition + 4);
            color.b = BitConverter.ToSingle(values, valuePosition + 8);
            color.a = BitConverter.ToSingle(values, valuePosition + 12);
            return color;
        }
        ...
        {
            var rect = new Rect();
            rect.x = BitConverter.ToSingle(values, valuePosition);
            rect.y = BitConverter.ToSingle(values, valuePosition + 4);
            rect.width = BitConverter.ToSingle(values, valuePosition + 8);
            rect.height = BitConverter.ToSingle(values, valuePosition + 12);
            return rect;
        }
        ...
        public static Matrix4x4 BytesToMatrix4x4(byte[] values, int valuePosition)
        {
            ...
            matrix4x4.m00 = BitConverter.ToSingle(values, valuePosition);
            matrix4x4.m01 = BitConverter.ToSingle(values, valuePosition + 4);
            matrix4x4.m02 = BitConverter.ToSingle(values, valuePosition + 8);
            matrix4x4.m03 = BitConverter.ToSingle(values, valuePosition + 12);
            matrix4x4.m10 = BitConverter.ToSingle(values, valuePosition + 16);
            matrix4x4.m11 = BitConverter.ToSingle(values, valuePosition + 20);
            matrix4x4.m12 = BitConverter.ToSingle(values, valuePosition + 24);
            matrix4x4.m13 = BitConverter.ToSingle(values, valuePosition + 28);
            matrix4x4.m20 = BitConverter.ToSingle(values, valuePosition + 32);
            matrix4x4.m21 = BitConverter.ToSingle(values, valuePosition + 36);
            matrix4x4.m22 = BitConverter.ToSingle(values, valuePosition + 40);
            matrix4x4.m23 = BitConverter.ToSingle(values, valuePosition + 44);
            matrix4x4.m30 = BitConverter.ToSingle(values, valuePosition + 48);
            matrix4x4.m31 = BitConverter.ToSingle(values, valuePosition + 52);
            matrix4x4.m32 = BitConverter.ToSingle(values, valuePosition + 56);
            matrix4x4.m33 = BitConverter.ToSingle(values, valuePosition + 60);
            return matrix4x4;
        }
        ...
        public static AnimationCurve BytesToAnimationCurve(byte[] values, int valuePosition)
        {
            ...
            var keyCount = BitConverter.ToInt32(values, valuePosition);
            for (int i = 0; i < keyCount; ++i) {
                var keyframe = new Keyframe();
                keyframe.time = BitConverter.ToSingle(values, valuePosition + 4);
                keyframe.value = BitConverter.ToSingle(values, valuePosition + 8);
                keyframe.inTangent = BitConverter.ToSingle(values, valuePosition + 12);
                keyframe.outTangent = BitConverter.ToSingle(values, valuePosition + 16);
                animationCurve.AddKey(keyframe);
                valuePosition += 16;
            }
            animationCurve.preWrapMode = (WrapMode)BitConverter.ToInt32(values, valuePosition + 4);
            animationCurve.postWrapMode = (WrapMode)BitConverter.ToInt32(values, valuePosition + 8);
