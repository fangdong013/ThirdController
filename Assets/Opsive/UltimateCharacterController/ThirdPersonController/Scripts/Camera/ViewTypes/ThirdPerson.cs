...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Camera.ViewTypes
{
    ...
    public abstract class ThirdPerson : ViewType
    {
        ...
        [SerializeField] protected float m_CollisionRadius = 0.1f;
        ...
        public override Vector3 Move(bool immediateUpdate)
        {
            ...
            if (Physics.SphereCast(anchorPosition, m_CollisionRadius, direction.normalized, out m_RaycastHit, direction.magnitude, 
                ...
                if (!immediateUpdate) {
                    targetPosition = Vector3.SmoothDamp(m_Transform.position, targetPosition, ref m_SmoothPositionVelocity, m_ObstructionPositionSmoothing);
                }
