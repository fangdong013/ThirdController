...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Items
{
    ...
    public class ThirdPersonPerspectiveItem : PerspectiveItem
    {
        ...
        {
            var character = GetComponentInParent<ItemHandler>().gameObject;
        ...
        public override void SetActive(bool active)
        {
            ...
            if (m_CharacterIK != null) {
                m_CharacterIK.SetItemIKTargets(m_ParentBone, (active ? m_NonDominantHandIKTarget : null), (active ? m_NonDominantHandIKTargetHint : null));
            }
        }
